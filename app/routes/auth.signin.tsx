      ...
      <div className="w-full max-w-sm space-y-8 px-4">
        <div className="text-center">
          <Link to="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-2xl font-bold">SoarCast</span>
          </Link>
          <p className="mt-4 text-muted-foreground">Sign in to track your flying sites</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <Button onClick={handleGitHubSignIn} variant="outline" className="w-full" size="lg">
